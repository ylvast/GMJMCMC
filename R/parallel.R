...
#' @export
gmjmcmc.parallel <- function (runs, cores = getOption("mc.cores", 2L), merge.options = list(populations = "best", complex.measure = 1, tol = 0), data, loglik.pi, loglik.alpha, transforms, ...) {
